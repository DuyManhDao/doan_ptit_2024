package com.doan.application.repository;

import com.doan.application.model.dto.ChartDTO;
...
//    @Query(value = "SELECT NEW dto.model.com.doan.application.ProductInfoDTO(p.id, p.name, p.slug, p.price ,p.images ->> '$[0]', p.total_sold) " +
//            "FROM product p " +
//            "WHERE p.status = 1 " +
